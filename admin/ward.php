...
$query = "select  ward.wardno, patient.name, patient.age, patient.gender, patient.mobile, patient.address from patient left join ward on patient.wardno = ward.wardno";
 ?>
