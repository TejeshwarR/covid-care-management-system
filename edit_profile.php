 		...
 		<div class="col-md-4">
 			<form action="" method="post">
 				...
 				<div class="form-group">
 					...
 					<input type="text" class="form-control" value="<?php echo $logid;?>" name="logid">
 				</div>
 				<div class="form-group">
 					<label>Mobile:</label>
...
$connection = mysqli_connect("localhost","root","");
$db = mysqli_select_db($connection,"cms");
$query = "update patient set name='$_POST[name]',age='$_POST[age]',gender='$_POST[gender]',logid='$_POST[logid]',mobile='$_POST[mobile]',address='$_POST[address]' where logid ='$_SESSION[logid]'";
$query_run = mysqli_query($connection,$query);
 ?>
